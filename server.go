...
func setupRouter() *gin.Engine {
	routes := []server.Route{
		...
		server.Route{Method: "GET", Path: "/info/provenance", Handler: ProvInfoHandler, Authorized: false},
		server.Route{Method: "GET", Path: "/info/specscans", Handler: SpecScansInfoHandler, Authorized: false},
		...
		server.Route{Method: "GET", Path: "/sync", Handler: SyncHandler, Authorized: false},
		server.Route{Method: "POST", Path: "/sync", Handler: SyncFormHandler, Authorized: false},
		...
		server.Route{Method: "POST", Path: "/doipublic", Handler: DoiPublicHandler, Authorized: false},
		server.Route{Method: "POST", Path: "/aichat", Handler: AIChatHandler, Authorized: false},
	}
